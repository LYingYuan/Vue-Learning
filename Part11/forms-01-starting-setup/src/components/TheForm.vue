<template>
  <form @submit.prevent="submitForm">
    <div class="form-control" :class="{invalid: user_name_validity === 'invalid'}">
      ...
      <input id="user-name" name="user-name" type="text" v-model.trim="user_name" @blur="validateInput"/>
      <p v-if="user_name_validity === 'invalid'">Please enter a valid name!</p>
    </div>
    <div class="form-control">
      <label for="age">Your Age (Years)</label>
      <input id="age" name="age" type="number" v-model="user_age" ref="age_input"/>
    </div>
    <div class="form-control">
    ...
    <div class="form-control">
      ...
      <div>
        <input id="interest-nothing" name="interest" type="checkbox" value="noting" v-model="interest"/>
...
export default {
  ...
  methods: {
    submitForm() {
      ...
      // console.log(typeof(this.$refs.age_input.value));
      // console.log(31);
      this.user_age = null;
    ...
    validateInput() {
      if(this.user_name === ''){
        this.user_name_validity = 'invalid';
      }else {
